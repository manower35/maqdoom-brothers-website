...
const CATALOG_DATA = [
  {
    id: "sherwani-01",
    title: "The Nizam Darbar Khada Sherwani",
    category: "sherwani",
...
// FAQs regarding Maqdoom Bros
const STORE_FAQS = [
  {
    question: "What is the starting price of a Sherwani at Maqdoom Brothers?",
    answer: "Our ready-to-wear and semi-custom Sherwanis start from ₹10,000 to ₹40,000, while bespoke bridal haute-couture pieces with extensive hand-zardozi and raw silk work range according to craftsmanship and custom fabric selection."
  },
  {
    question: "How long does custom bespoke tailoring take?",
    answer: "A custom bespoke sherwani or bandhgala typically takes 2 to 3 weeks, including hand embroidery and two fitting trials. Express bridal stitching (7-10 days) can be arranged upon request for urgent wedding dates."
  },
  {
    question: "Do you offer international shipping for NRI clients?",
    answer: "Yes! We dress grooms across the USA, UK, UAE, Canada, and Australia. We offer live video measurement consultations, fabric selection via high-res video, and worldwide doorstep DHL/FedEx courier delivery."
  },
  {
    question: "Where is the flagship store located and what are your timings?",
    answer: "Our historic flagship store is located at Shop No. 22-7-267/a11, Pathergatti Road, Opposite Madina Building, Hyderabad - 500002. We are open all 7 days from 10:30 AM to 11:00 PM."
  },
  {
